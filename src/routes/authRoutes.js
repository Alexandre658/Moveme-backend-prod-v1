...
import { enviarCodigo, verificarCodigoInserido, adicionarTelefone, verificarCodigoTelefoneController, adicionarEmail, verificarCodigEmail } from '../controllers/authController.js';
...
router.post('/email/adicionar', apiKeyMiddleware, adicionarEmail);

// Rota para verificar o código de verificação do email
router.post('/email/verificar', apiKeyMiddleware, verificarCodigEmail);
